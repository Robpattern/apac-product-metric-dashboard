...
export const PROJECT_BY_TICKET = {
  ...
  // Inventory — China. Parent is ATECH-6835, which the confirmation sheet files under
  // Inventory — China, and it's Shelen's. Move to invncn if it's really non-China.
  "ATECH-6836": "invcn",  // Demand Planning — Demand Driven Automated Reorder Plan

  "ATECH-6781":  "predictcn",
  "ATECH-6839":  "predictcn",
  "ATECH-10965": "predictcn",
  // Left as Predict China pending a call — it was named twice in one batch, once as
  // Predict China and once as an exclusion.
  "ATECH-7298":  "predictcn", // BM Feedback: Add more metrics in Monthly Report trend charts
